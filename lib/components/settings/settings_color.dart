      ...
      content: SingleChildScrollView(
        child: ColorPicker(
          ...
          onColorChanged: (Color color) {
            Prefs.accentColor.value = color.value32bit;
          },
        ),
      ),
      actions: [
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
        ...
        children: [
          ...
          Switch.adaptive(
            ...
            onChanged: (bool? value) {
              ...
              widget.pref.value = value ? defaultColor.value32bit : 0;
            },
          )
        ],
      ),
      onTap: () async {
        ...
        widget.pref.value = defaultColor.value32bit; // enable accent color
